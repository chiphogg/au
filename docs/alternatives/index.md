...
- [**nholthaus/units**](https://github.com/nholthaus/units) (versions: 2.3.5, and 3.5.1)
    ...
    - We assess the 2.x and 3.x lines in **separate columns**, because they are effectively
      different libraries.  3.x requires C++23 (2.x targeted C++14), renames the core vocabulary,
      and closes a large number of long-standing gaps.  As of August 2026, 3.x is the project's
      default branch, and the 2.x line has been archived (branch `archive/2.3.5`).
    - If you are choosing today, the deciding question is usually simply whether you can require
      C++23.  If you can't, the 2.x column is the one that applies to you --- and it now
    ...
    <tr>
        <td>
            <details class="criterion">
                ...
                <p>We look for four things, and rate a library by how many it covers:</p>
                <ol>
...
<table class="matrix">
    ...
    <tr>
        ...
        <td class="poor">
            ...
            <ul>
                <li class="x">
                    Archived as of August 2026 (branch <code>archive/2.3.5</code>); superseded by
                    3.x
                </li>
                <li class="x">Last release September 2025; no further backports</li>
            </ul>
        </td>
        <td class="good nh3">
            <ul>
