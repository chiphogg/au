...
struct ApplyIfImpl;
template <template <class> class Condition, template <class...> class Pack, typename... Ts>
using ApplyIf = typename ApplyIfImpl<Condition, Pack, Ts...>::type;
...
template <template <class> class Condition, template <class...> class Pack, typename... Ts>
struct ApplyIfImpl : stdx::type_identity<
...
struct DropAllImpl<T, Pack<H, Ts...>> : std::conditional<std::is_same<T, H>::value,
                                                         DropAll<T, Pack<Ts...>>,
                                                         PrependT<DropAll<T, Pack<Ts...>>, H>> {};
